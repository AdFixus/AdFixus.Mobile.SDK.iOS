...
Pod::Spec.new do |spec|
  ...
  spec.name             		= 'AdFixus-Mobile-Ads-SDK'
  spec.platform 			= :ios
  ...
  spec.source           		= { :http => 'https://github.com/AdFixus/AdFixus.Mobile.SDK.iOS/raw/DirectReference/Release/1.0.0/AdFixusMobileAds-1.0.0.tar.gz' } 
  ...
  spec.vendored_frameworks = ["Frameworks/AdFixusMobileAdsFramework-Current/AdFixusMobileAds.xcframework"]
  spec.version          		= '1.0.0'
